...
public class AimBehaviourBasic : GenericBehaviour
{
    ...
    public Vector3 aimPivotOffset = new(0.5f, 1.2f, 0f); // Offset to repoint the camera when aiming.
    public Vector3 aimCamOffset = new(0f, 0.4f, -0.7f); // Offset to relocate the camera when aiming.
    ...
    private void Update()
    {
        ...
        else if (aim && Input.GetAxisRaw(aimButton) == 0) StartCoroutine(ToggleAimOff());
